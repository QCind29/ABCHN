...
import com.food.lite.nckh.detection.adapter.SenAdapter;
...
public class DetectGallery extends AppCompatActivity {
    ...
    private static final String TF_OD_API_MODEL_FILE = "best-fp160.tflite";
...
///////////////////////////////////////////////////////////////////
       ...
       // sat = new SenAdapter(this, sqlvob.getSen());
        rcv.setAdapter(sat);
...
//////////////////////////////////////////////        //Them bien w
        ...
        if(maxClass != "") {
            ...
            w = w.concat(maxClass);
//            String sen = "";
//            sen = String.valueOf(sqlvob.getSen(w));
            sqlvob = new sqlVob(this);
            ...
            sat = new SenAdapter(this, sqlvob.getSen(w));
            rcv.setAdapter(sat);
