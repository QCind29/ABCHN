...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        if (modelFilename.equals("best-fp160.tflite")) {
        ...
        else if (modelFilename.equals("best-fp160s.tflite")) {
            labelFilename = "file:///android_asset/cocos.txt";
            isQuantized = false;
            inputSize = 640;
            output_width = new int[]{80, 40, 20};
            masks = new int[][]{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
        ...
        else if (modelFilename.equals("best-fp160l.tflite")) {
            labelFilename = "file:///android_asset/coco.txt";
            isQuantized = false;
            inputSize = 640;
            output_width = new int[]{80, 40, 20};
        ...
        else if (modelFilename.equals("best-fp1.tflite")) {
            labelFilename = "file:///android_asset/co.txt";
            isQuantized = true;
            inputSize = 640;
            output_width = new int[]{80, 40, 20};
            masks = new int[][]{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
